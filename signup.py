...
class Ui_signup(object):
	def insertData(self):
        	...
        	connection.execute("INSERT INTO akash VALUES(?,?,?)",(str(username),str(email),str(password)))
        	connection.commit()
        	connection.close()
	def setupUi(self, Dialog):
        	Dialog.setObjectName(_fromUtf8("Dialog"))
        	Dialog.resize(748, 596)
		...
		self.signup_btn.clicked.connect(self.insertData)                              #insert data on click
